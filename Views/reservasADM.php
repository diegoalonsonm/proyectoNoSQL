    ...
    <div class="col-md-12 text-center">
      <div class="card card-light" style="background-color: rgba(51, 51, 51, 0.8); color: white; border-radius: 8px;">
        <div class="card-header" style="background-color: rgba(51, 51, 51, 0.8); color: white;">
          <h1 class="card-title" style="text-align: center">Listado de Reservas</h1>
        </div>
        <!-- /.card-header -->
        <div class="card-body p-0">
          <div class="row mt-2">
            ...
            <div class="col-md-10">
              <table id="tablaReservas" class="table table-striped table-bordered table-hover" style="background-color: rgba(167, 167, 167, 0.8); color: white !important;">
